...
public class OneBallAndTerminal extends AutoModeBase {
    Superstructure s;
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        runAction(new SetFeederState(FeederState.SHOOTING));
            ...
            runAction(new SetFeederState(FeederState.INTAKING));
            runAction(new SetTrajectoryAction(trajectories.oneBallTerminal, -45.0, 1.0));
            runAction(new RemainingProgressAction(0.05));
            runAction(new WaitAction(0.75));
            runAction(new SetTrajectoryAction(trajectories.oneBallTerminalShot, 0.0, 1.0));
