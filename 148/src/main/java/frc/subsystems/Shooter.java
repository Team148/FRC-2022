...
public class Shooter extends Subsystem {
  ...
  private Shooter() {
    ...
    // ShooterMaster.setStatusFramePeriod(StatusFrame.Status_6_Misc, 1000, Constants.kLongCANTimeoutMs);
    // ShooterMaster.setStatusFramePeriod(StatusFrame.Status_7_CommStatus, 1000, Constants.kLongCANTimeoutMs);
    ...
    // ShooterMaster.setStatusFramePeriod(StatusFrame.Status_15_FirmwareApiStatus, 1000, Constants.kLongCANTimeoutMs);
