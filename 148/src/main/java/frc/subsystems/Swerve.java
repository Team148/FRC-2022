...
public class Swerve extends Subsystem{
	...
	private Swerve(){
		 ...
		 * 		
		 */
		frontRight = new SwerveDriveModule(RobotMap.FRONT_RIGHT_ROTATION, RobotMap.FRONT_RIGHT_DRIVE, RobotMap.FRONT_RIGHT_CODER,
				0, Constants.kFrontRightEncoderStartingPos, Constants.kVehicleToModuleZero, true);
		frontLeft = new SwerveDriveModule(RobotMap.FRONT_LEFT_ROTATION, RobotMap.FRONT_LEFT_DRIVE, RobotMap.FRONT_LEFT_CODER,
				1, Constants.kFrontLeftEncoderStartingPos, Constants.kVehicleToModuleOne, true);
		rearLeft = new SwerveDriveModule(RobotMap.REAR_LEFT_ROTATION, RobotMap.REAR_LEFT_DRIVE, RobotMap.REAR_LEFT_CODER,
				2, Constants.kRearLeftEncoderStartingPos, Constants.kVehicleToModuleTwo, true);
		rearRight = new SwerveDriveModule(RobotMap.REAR_RIGHT_ROTATION, RobotMap.REAR_RIGHT_DRIVE, RobotMap.REAR_RIGHT_CODER,
		...
		*/
		...
		rearRight.invertDriveMotor(TalonFXInvertType.Clockwise);
		
		modules.forEach((m) -> m.reverseRotationSensor(true)); //1323 was true
