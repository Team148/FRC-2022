...
public class Kinematics {
    private static final double L = Constants.kWheelbaseLength;
    private static final double W = Constants.kWheelbaseWidth;
    ...
    public static DriveSignal inverseKinematics(double forward, double strafe, double rotation, boolean field_relative,
        ...
        if (field_relative) {
            Rotation2d gyroHeading = Swerve.getInstance().getHeading();
